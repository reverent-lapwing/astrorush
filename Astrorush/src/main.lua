...
function disable_handlers(obj)
   ...
   table.remove(handler.update, obj.id)
   end
   if handlers.draw[obj.id] then 
   table.remove(handler.draw, obj.id)
   end
   if handlers.mousepressed[obj.id] then 
   table.remove(handler.mousepressed, obj.id)
   end
   if handlers.mousereleased[obj.id] then 
   table.remove(handler.mousereleased, obj.id)
   end
   if handlers.keypressed[obj.id] then 
   table.remove(handler.keypressed, obj.id)
   end
   if handlers.keyreleased[obj.id] then 
   table.remove(handler.keyreleased, obj.id)
   end
   if handlers.textinput[obj.id] then 
   table.remove(handler.textinput, obj.id)
   end
   if handlers.focus[obj.id] then 
   table.remove(handler.focus, obj.id)
   end
